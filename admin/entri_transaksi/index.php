...
// SET TITLE
$titleObj = new Title();
$title = $titleObj->showTitle('Data Transaksi');
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($data_transaksi as $transaksi) : ?>
                                        <tr>
                                            ...
                                            <td class="col-2">
                                                <a href="edit.php?id=<?= $transaksi['id']; ?>" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i> Edit</a>
                                                <a href="hapus.php?id=<?= $transaksi['id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')"> <i class="fas fa-trash"></i>Hapus</a>
                                            </td>
                                        </tr>
                                        <?php $no++ ?>
                                    <?php endforeach; ?>
